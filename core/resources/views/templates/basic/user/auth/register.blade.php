                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control form--control checkUser" name="username" value="{{ old('username') }}" placeholder="username12" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <input type="email" class="form-control form--control checkUser" name="email" value="{{ old('email') }}" placeholder="you@email.com" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="number" name="mobile" value="{{ old('mobile') }}" class="form-control form--control checkUser" placeholder="1234567890" required>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            <label class="form-label">@lang('Sponsor Id')</label>
                            <div class="input-group ">
                                <input type="text" name="sponsor_id" value="{{ old('sponsor_id') }}" class="form-control form--control checkUser" placeholder="12345">
                            </div>
                            <small class="text--danger mobileExist"></small>
                        </div>
                    </div> -->
