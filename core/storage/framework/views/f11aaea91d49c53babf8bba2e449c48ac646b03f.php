            ...
            <div class="row gy-5">
                ...
                <div class="col-lg-6">
                    <div class="contact__form__wrapper">
                        ...
                        <P><?php echo app('translator')->get("You can feel free to contact me for any problem, even if someone rejects the documents submitted for your job, you can also report it."); ?></P></br>
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Program file\xampp soft\htdocs\MicroLab_v2\Files\core\resources\views/templates/basic/contact.blade.php ENDPATH**/ ?>