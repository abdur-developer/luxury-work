                ...
                <div class="container">
                    <div class="overview__content ps-lg-4 ps-xxl-5 padding-top padding-bottom">
                        <div class="section__header mb-0">
                            ...
                            <a href="<?php echo e(@$overviewContent->data_values->left_button_link); ?>" class="btn"><?php echo e(__(@$overviewContent->data_values->right_button_text)); ?></a>
                        </div>
                    </div>
                </div>
...
<?php /**PATH F:\Program file\xampp soft\htdocs\MicroLab_v2\Files\core\resources\views/templates/basic/sections/overview.blade.php ENDPATH**/ ?>