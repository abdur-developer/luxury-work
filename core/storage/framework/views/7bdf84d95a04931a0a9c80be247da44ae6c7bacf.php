                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <input type="text" class="form-control form--control checkUser" name="username" value="<?php echo e(old('username')); ?>" placeholder="username12" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <input type="email" class="form-control form--control checkUser" name="email" value="<?php echo e(old('email')); ?>" placeholder="you@email.com" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <div class="input-group ">
                                ...
                                <input type="number" name="mobile" value="<?php echo e(old('mobile')); ?>" class="form-control form--control checkUser" placeholder="1234567890" required>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            <label class="form-label"><?php echo app('translator')->get('Sponsor Id'); ?></label>
                            <div class="input-group ">
                                <input type="text" name="sponsor_id" value="<?php echo e(old('sponsor_id')); ?>" class="form-control form--control checkUser" placeholder="12345">
                            </div>
                            <small class="text--danger mobileExist"></small>
                        </div>
                    </div> -->
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <input type="password" class="form-control form--control" name="password" placeholder="*********" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group ">
                            ...
                            <input type="password" class="form-control form--control" name="password_confirmation" placeholder="*********" required>
                        </div>
                    </div>
...
<?php echo $__env->make($activeTemplate . 'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Program file\xampp soft\htdocs\MicroLab_v2\Files\core\resources\views/templates/basic/user/auth/register.blade.php ENDPATH**/ ?>