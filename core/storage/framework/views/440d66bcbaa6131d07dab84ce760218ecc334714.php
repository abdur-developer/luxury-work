...
<div class="<?php if(request()->routeIs('home')): ?> section-bg <?php endif; ?>">
    <div class="container">
        <div class="get-started d-flex flex-wrap align-items-center justify-content-between">
            ...
            <a href="<?php echo e(@$startedContent->data_values->button_link); ?>" class="cmn--btn"><?php echo e(__(@$startedContent->data_values->button_text)); ?></a>
        </div>
    </div>
</div>
<?php /**PATH F:\Program file\xampp soft\htdocs\MicroLab_v2\Files\core\resources\views/templates/basic/partials/get_started.blade.php ENDPATH**/ ?>