            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td>
                            <div class="text--end">
                                <span class="time"><?php echo e(showDateTime($job->created_at, 'M d, Y h:i:s a')); ?><br><?php echo e(diffForHumans($job->created_at)); ?></span>
                            </div>
                        </td>
                        <td>
                            <div class="d-flex flex-wrap table-icon">
                                <a href="<?php echo e(!($job->status == Status::JOB_REJECTED || $job->status == Status::JOB_COMPLETED) ? route('user.job.edit', $job->id) : 'javascript:void(0)'); ?>" class="text--success me-2 <?php echo e($job->status == Status::JOB_REJECTED || $job->status == Status::JOB_COMPLETED ? 'disabled' : ''); ?> " data-bs-toggle="tooltip" title="Edit">
...
<?php echo $__env->make($activeTemplate . 'layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Program file\xampp soft\htdocs\MicroLab_v2\Files\core\resources\views/templates/basic/user/job/history.blade.php ENDPATH**/ ?>