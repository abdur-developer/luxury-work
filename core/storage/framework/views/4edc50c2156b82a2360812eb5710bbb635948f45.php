                        ...
                        <?php else: ?>
                            <div class="job__details__widget">
                                <h4 class="job__details__widget-title text-center text--base">
                                    <?php echo app('translator')->get('You are already submited job prove please wait until review complte'); ?>
                                </h4>
                            </div>
                        <?php endif; ?>
                    </div>
                        ...
                        <div class="sidebar__widget">
                            ...
                            <div class="info__wrapper">
                                ...
                                <div class="info__item">
                                    ...
                                    <div class="content">
                                        <h4 class="title"><?php echo e(showDateTime($job->created_at, 'M d, Y h:i:s a')); ?></h4>
...
<?php echo $__env->make($activeTemplate . 'layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Program file\xampp soft\htdocs\MicroLab_v2\Files\core\resources\views/templates/basic/job/details.blade.php ENDPATH**/ ?>